...
public class AndroidDevFragment extends Fragment {
    private String mFrom;

    public static AndroidDevFragment newInstance(String from) {
        AndroidDevFragment fragment = new AndroidDevFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        content.setText(getString(R.string.android_dev_fragment));
        return view;
    }
}
